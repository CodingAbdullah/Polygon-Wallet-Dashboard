...
# ---> .\POLYGON_WALLET_PROJECT_SETUP.ps1 <laptop name>
...
mkdir LOCAL_POLYGON_PROJECT_ENV

cd LOCAL_POLYGON_PROJECT_ENV
...
echo 'LOCAL_POLYGON_PROJECT_ENV project setup is complete!'
