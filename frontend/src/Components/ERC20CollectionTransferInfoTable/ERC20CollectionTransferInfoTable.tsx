...
const ERC20TransfersInfoTable = (props : { data : ERC20CollectionTransferInformationType, address: string }) => {
        ...
        <div className= "p-3" style={{ overflowX: 'scroll', paddingBottom: '2rem' }}>
            <table style={{ border: '1px solid black' }}>
                ...
                <tr style={{ border: '1px solid black' }}>
                    ...
                    <th style={{ border: '1px solid black' }} scope="col">ERC-20 Quantity (Wei)</th>
                </tr>
                </thead>
                <tbody>
                    { 
                        data.result.reverse().map((record, key) => {
                            ...
                            return (
                                <tr style={{ border: '1px solid black' }}>
                                    ...
                                    <td style={{ border: '1px solid black', fontSize: '11px' }}>{ record.block_timestamp.split("T")[0] + " - " + record.block_timestamp.split("T")[1].split(".")[0] }</td>
