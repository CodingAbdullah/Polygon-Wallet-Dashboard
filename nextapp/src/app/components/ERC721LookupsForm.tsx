...
import ERC721LookupTransfersInfoTable from './ERC721LookupTransfersInfoTable';
...
export default function ERC721LookupsForm() {
    ...
    return (
        <>        
            ...
            { tableStatus ? <ERC721LookupsInfoTable address={tokenAddressRef.current!.value.trim()} tokenID={tokenIDRef.current!.value.trim()} /> : null }
            { tableStatus ? <ERC721LookupTransfersInfoTable address={tokenAddressRef.current!.value.trim()} tokenID={tokenIDRef.current!.value.trim()} /> : null } 
        </>
    )
}